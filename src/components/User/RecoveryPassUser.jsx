...
import {API_SEND_CODE_USER } from "../../config/api";
import axios from "axios";
import SvgShaper from "../SvgShaper";
function RecoveryPassUser() {
      ...
      <div className="bg-white dark:bg-[#37415197] dark:text-white w-4/5 sm:w-[30rem] rounded mt-9 mx-auto p-1  my-3">
        ...
        <Formik
          ...
          onSubmit={async (values) => {
            ...
            const response = await axios.post(API_SEND_CODE_USER, { email: emailString });
