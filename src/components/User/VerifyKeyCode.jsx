...
import { API_VERIFY_CODE_KEY } from '../../config/api';
    ...
    function handleVerifyCode() {
      ...
      const handleForm = async (e) => {
        ...
        if (
          ...
          const response = await axios.post(API_VERIFY_CODE_KEY, data);
          if (response.status === 201) {
            return (
              ...
              setTimeout(() => {
                window.location.href = "/ResetKeyWithdrawal";
              }, 2000)
            );
          }
